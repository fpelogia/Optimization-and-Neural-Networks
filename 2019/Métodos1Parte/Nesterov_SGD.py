...
def SGD(X, y, t, gamma, batch_size = 5):
    ...
    while n_iter < 10000:
        ...
        #A MAGIA DE NESTEROV ESTÁ AQUI
        grad, grad_h = grad_f(X, y, w1 + gamma*m1, w2 + gamma*m2, batch_size)
...
#=============== plotando resultados ====================
    ...
    plt.title("SGD com momento de Nesterov: gamma {} e batch_size = {}  \nRegressão de x²: m = {}".format(gamma, batch_size, m))
