...
def grad_f_SAG(x,y,w1,w2,w1_history, w2_history,w_time_hist, n_iter,soma_old, soma_h_old):
...
def SAG(X, y, t):
    ...
    while True:
        ...
        if n_iter == 0:
            ...
            soma_old = 5*grad
            soma_h_old = 5*grad_h
            grad, grad_h = grad_f_SAG(X, y, w1, w2, w1_history, w2_history,w_time_hist,n_iter, soma_old, soma_h_old)
