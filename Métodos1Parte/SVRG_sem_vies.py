...
def grad_f_SVRG(x, y, w1, w2, w1_old, w2_old, grad_mg, grad_h_mg):
    ...
    #gradiente = Grad metodo do gradiente - gradiente_antigo + gradiente_novo
    grad = grad_mg - grad_old + grad_new
    grad_h = grad_h_mg - grad_h_old + grad_h_new
...
def SVRG(X, y, t, r):
    ...
    while True:
        ...
        if n_iter+1 == 1 or (n_iter+1) % r == 0:
            ...
            grad, grad_h = grad_f_SVRG(X, y, w1, w2, w1_old, w2_old, grad_mg, grad_h_mg)
